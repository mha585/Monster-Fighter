			...
			gl_panelMonster2.createParallelGroup(Alignment.LEADING)
				.addGroup(gl_panelMonster2.createSequentialGroup()
					...
					.addGroup(gl_panelMonster2.createParallelGroup(Alignment.LEADING)
						.addGroup(gl_panelMonster2.createSequentialGroup()
							.addGroup(gl_panelMonster2.createParallelGroup(Alignment.LEADING)
								.addComponent(lblSpeed_1, GroupLayout.PREFERRED_SIZE, 52, GroupLayout.PREFERRED_SIZE)
								.addComponent(lblHealth_1, GroupLayout.PREFERRED_SIZE, 52, GroupLayout.PREFERRED_SIZE))
							.addGap(22)
							.addGroup(gl_panelMonster2.createParallelGroup(Alignment.LEADING)
								.addGroup(gl_panelMonster2.createSequentialGroup()
									...
									.addComponent(lblMaxHealth_1, GroupLayout.PREFERRED_SIZE, 50, GroupLayout.PREFERRED_SIZE))
						...
						.addComponent(lblAttack_1, GroupLayout.PREFERRED_SIZE, 52, GroupLayout.PREFERRED_SIZE)
						.addGroup(gl_panelMonster2.createSequentialGroup()
							.addGroup(gl_panelMonster2.createParallelGroup(Alignment.LEADING)
			...
			gl_panelMonster3.createParallelGroup(Alignment.TRAILING)
				.addGroup(gl_panelMonster3.createSequentialGroup()
					...
					.addGroup(gl_panelMonster3.createParallelGroup(Alignment.LEADING)
						.addGroup(gl_panelMonster3.createSequentialGroup()
							.addGroup(gl_panelMonster3.createParallelGroup(Alignment.LEADING)
								.addComponent(lblSpeed_2, GroupLayout.PREFERRED_SIZE, 52, GroupLayout.PREFERRED_SIZE)
								.addComponent(lblHealth_2, GroupLayout.PREFERRED_SIZE, 52, GroupLayout.PREFERRED_SIZE))
							.addGap(22)
							.addGroup(gl_panelMonster3.createParallelGroup(Alignment.LEADING)
								.addGroup(gl_panelMonster3.createSequentialGroup()
									...
									.addPreferredGap(ComponentPlacement.UNRELATED)
									.addComponent(lblMaxHealth_2, GroupLayout.PREFERRED_SIZE, 50, GroupLayout.PREFERRED_SIZE))
						...
						.addComponent(lblAttack_2, GroupLayout.PREFERRED_SIZE, 52, GroupLayout.PREFERRED_SIZE)
						.addGroup(gl_panelMonster3.createSequentialGroup()
							.addGroup(gl_panelMonster3.createParallelGroup(Alignment.LEADING)
			...
			gl_panelMonster4.createParallelGroup(Alignment.LEADING)
				.addGroup(gl_panelMonster4.createSequentialGroup()
					...
					.addGroup(gl_panelMonster4.createParallelGroup(Alignment.LEADING)
						.addGroup(gl_panelMonster4.createSequentialGroup()
							.addGroup(gl_panelMonster4.createParallelGroup(Alignment.LEADING)
								.addComponent(lblSpeed_3, GroupLayout.PREFERRED_SIZE, 52, GroupLayout.PREFERRED_SIZE)
								.addComponent(lblHealth_3, GroupLayout.PREFERRED_SIZE, 52, GroupLayout.PREFERRED_SIZE))
							.addGap(22)
							.addGroup(gl_panelMonster4.createParallelGroup(Alignment.LEADING)
								.addGroup(gl_panelMonster4.createSequentialGroup()
									...
									.addPreferredGap(ComponentPlacement.UNRELATED)
									.addComponent(lblMaxHealth_3, GroupLayout.PREFERRED_SIZE, 50, GroupLayout.PREFERRED_SIZE))
						...
						.addComponent(lblAttack_3, GroupLayout.PREFERRED_SIZE, 52, GroupLayout.PREFERRED_SIZE)
						.addGroup(gl_panelMonster4.createSequentialGroup()
							.addGroup(gl_panelMonster4.createParallelGroup(Alignment.LEADING)
			...
			gl_panelMonster1.createParallelGroup(Alignment.LEADING)
				...
				.addGroup(gl_panelMonster1.createSequentialGroup()
					...
					.addGroup(gl_panelMonster1.createParallelGroup(Alignment.LEADING)
						.addGroup(gl_panelMonster1.createSequentialGroup()
							.addGroup(gl_panelMonster1.createParallelGroup(Alignment.LEADING)
								.addComponent(lblSpeed, GroupLayout.PREFERRED_SIZE, 52, GroupLayout.PREFERRED_SIZE)
								.addComponent(lblHealth, GroupLayout.PREFERRED_SIZE, 52, GroupLayout.PREFERRED_SIZE))
							.addGap(22)
							.addGroup(gl_panelMonster1.createParallelGroup(Alignment.LEADING)
								.addGroup(gl_panelMonster1.createSequentialGroup()
									...
									.addPreferredGap(ComponentPlacement.UNRELATED)
									.addComponent(lblMaxHealth, GroupLayout.PREFERRED_SIZE, 50, GroupLayout.PREFERRED_SIZE))
						...
						.addComponent(lblAttack, GroupLayout.PREFERRED_SIZE, 52, GroupLayout.PREFERRED_SIZE)
						.addGroup(gl_panelMonster1.createSequentialGroup()
							.addGroup(gl_panelMonster1.createParallelGroup(Alignment.LEADING)
